...
// Public:
    Player::Player(const QString& name, const bool& playerIsRed)
    : name(name), playerIsRed(playerIsRed)
    { }
...
// Public slots:
    void Player::mouseClick(const GameBoard::MouseClickEvent&)
    { }

    void Player::abortMoveRequest()
    { }

    void Player::moveUndone()
    { }
